...
FONT_PATH = '/home/robertmcasper/image_processing/image_processing/fonts/GreatVibes-Regular.ttf'
...
def initialize_metadata_file(metadata_path):
    ...
    with open(metadata_path, 'w', newline='') as csvfile:
        fieldnames = ['ProductID', 'FileName', 'Type', 'Width', 'Height', 'Thumbnail']
        writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
        writer.writeheader()

def update_metadata_file(metadata_path, product_id, file_name, image_type, width, height, thumbnail_name):
...
def generate_thumbnail(image, size=THUMBNAIL_SIZE):
...
def process_image(file_path, output_dir, product_id, image_index, image_type, font_path):
    try:
        ...
        thumbnail_name = f"Product_{product_id:05d}_Thumbnail_{image_index:02d}.png"
        ...
        update_metadata_file(metadata_path, product_id, output_file_name, image_type, resized_image_pil.width, resized_image_pil.height, thumbnail_name)
...
def main():
    input_dir = '/home/robertmcasper/image_processing/image_processing/input'
    output_dir = '/home/robertmcasper/image_processing/image_processing/output'
    metadata_path = os.path.join(output_dir, "metadata", "processed_images.csv")
    font_path = '/home/robertmcasper/image_processing/image_processing/fonts/GreatVibes-Regular.ttf'
